...
# This is copied together from existing approaches of other projects.   #
# We use this for the purpose of experimentation and proof of concept.  #
# Publishing this code in the current state might be a violation of     #
# licence agreements without crediting the original authors             #
#########################################################################
...
if sys.platform == "darwin":
    ...
    process = Popen('tcpdump -l -I -i '+iface+' -e -s 256 type mgt subtype probe-req', bufsize=1, universal_newlines=True,
    ...
    process = Popen(["/usr/sbin/tcpdump", "-i", iface, "-e", "-s", "256", "type mgt subtype probe-req"], bufsize=1, universal_newlines=True,
